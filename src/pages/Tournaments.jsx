...
import { Trophy, Users, Plus, Trash2, Award } from 'lucide-react'
                                ...
                                {players.map((player, idx) => (
                                    ...
                                    >
                                        <div className="flex items-center gap-4">
                                            <div className="w-8 h-8 rounded-full bg-pickle-green/10 flex items-center justify-center text-pickle-green font-bold text-xs border border-pickle-green/20">
                                                {idx + 1}
                                            </div>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                {round.matches.map((match, mIdx) => (
                                                    <div key={mIdx} className="p-6 bg-pickle-gray/50 rounded-2xl border border-white/5 flex items-center justify-between group">
                                                        <span className="font-black text-lg">{match.p1}</span>
                                                        <span className="text-[10px] font-black text-gray-500 tracking-widest px-4">VS</span>
                                                        <span className="font-black text-lg text-right">{match.p2}</span>
                                                    </div>
                                                ))}
                                            </div>
                                        </div>
